...
@section('content')
    <main>
        ...
        <div class="flex flex-col  place-items-center">
            ...
            <form action="{{route('store_user')}}" method="post" class="mt-6 pt-10 px-12 w-2/6 h-auto  shadow-xl pb-4
             shadow-gray-400 rounded-xl bg-white mx-auto">
                ...
                <div id="form1" class="hidden forms mt-5 flex flex-col gap-8">
                    <div class="flex-col flex  ">
                        ...
                        {!! $errors->first('nom' ,"<p class='bg-red-500''>remplissez ce champ</p>") !!}
                    </div>
                    ...
                    <div class="flex-col flex  ">
                        ...
                        {!! $errors->first('prenom' ,"<p class='bg-red-500'>remplissez ce champ</p>") !!}
                    ...
                    <div class="flex-col flex  ">
                        ...
                        {!! $errors->first('username' ,"<p class='bg-red-500''>remplissez ce champ</p>") !!}
                    </div>
                ...
                <div id="form2" class="hidden forms mt-5 flex flex-col gap-8">
                    ...
                    <div class="flex-col flex  ">
                        ...
                        {!! $errors->first('passwordVerify' ,"<p>:message<?p>") !!}
