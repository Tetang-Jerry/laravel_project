            ...
            <form action="{{ route('registerUser') }}" method="POST"
                ...
                <div id="form1" class="flex-col hidden gap-8 mt-5 forms">
                    ...
                    <div class="flex flex-col gap-5 text-xs text-gray-400 place-items-center">
                        <a href="{{ route('loginView') }}"
                            class="transition-all duration-300 ease-in-out hover:text-gray-700">Vous avez déjà un compte?
                            connectez-vous</a>
                    </div>
                </div>
                <div id="form2" class="flex-col hidden gap-8 mt-5 forms">
                    <div class="flex flex-col ">
                        ...
                        <input type="email" name="email" placeholder="Entrer votre addresse mail..." id="email"
                            class="px-3 py-3 border border-gray-400 rounded-md focus:border focus:outline-none focus:border-gray-800">
                ...
                <div id="form4" class="flex flex-col hidden gap-8 mt-5 forms">
                    ...
                    <div class="relative mx-auto w-fit">
                        ...
                        <div class="p-4 text-center md:p-5">
                            ...
                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Un code de verification
                            ...
                            <button type="submit"
                                class="submit-button text-white bg-green-600 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
                                Envoyez le code
                            </button>
                        </div>
                    </div>
