...
@section('content')
  ...
  <main>
      <a href="{{route('registerView2')}}" class=" flex place-items-center gap-1 pt-10 ml-5 text-center">
      ...
      <div class="relative w-fit mx-auto bg-white rounded-lg  shadow-xl pb-4 shadow-gray-400 mt-[200px]">
          ...
          <div class="p-4 md:p-5 text-center">
              ...
              <a href="{{route('codeView')}}" data-modal-hide="popup-modal" type="button" class="text-white bg-green-600 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
                  Envoyez le code
              </a>
          </div>
      </div>
