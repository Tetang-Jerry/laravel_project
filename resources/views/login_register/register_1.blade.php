...
@section('content')
    <main>
        <a href="{{route('registerView')}}" class="absolute flex place-items-center gap-1 pt-10 ml-5 text-center">
        ...
        <div class="flex flex-col  place-items-center">
            ...
            <form action="" method="post" class="mt-6 pt-10 px-12 w-2/6 h-auto  shadow-xl pb-4 shadow-gray-400 rounded-xl bg-white mx-auto">
                ...
                <div class="mt-5 flex flex-col gap-8">
                    ...
                    <div class="mt-5">
                        <a href="{{route('registerView2')}}"  class="cursor-pointer flex justify-center  text-primary text-center  w-[60%] rounded-md mx-auto py-3 border border-primary
