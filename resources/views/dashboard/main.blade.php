...
<div class="hidden lg:rounded-lg lg:shadow-lg lg:grid lg:grid-cols-5 lg:bg-[linear-gradient(to_right,_#C174EA,_#B7A4F0)] p-3">
    <div class="col-span-3">
        <p class="text-white font-bold text-xl uppercase md:text-3xl">protect your money</p>
        <p class="text-white font-500 md:text-lg">set up two-factor authentification the <br>when withdrawing money</p>
    </div>
